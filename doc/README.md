...
| **Магазин** | Привилегии на комиссию, мерч и сертификаты за внутренний баланс: витрина, покупка, очередь привилегий, возврат через поддержку, выручка. | [`shop.md`](./shop.md) |
