...
| **Загрузка данных на клиенте** | Кэш «сначала показать, потом догрузить», прелоадеры-скелетоны и индикаторы фоновой догрузки. | [`frontend_data_loading.md`](./frontend_data_loading.md) |
