...
* Вариант ищется среди включённых по `behavior_code = verification`, а не по коду
  узла. Узлы из миграции выключены: пока админ не включит услугу, эндпоинт
  отвечает «услуга верификации сейчас недоступна».
