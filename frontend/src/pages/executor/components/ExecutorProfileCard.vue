<template>
  <va-card class="p-4 mb-4 shadow-card">
    ...
    <div class="balance-box mt-4 p-3 text-center cursor-pointer hover-shadow transition" @click="$emit('openFinancialHistoryModal')">
...
export default defineComponent({
  ...
  emits: ['openFinancialHistoryModal'],
})
</script>
