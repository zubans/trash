...
pay_bonus(
    ...
    "events": ["order.submission"],
      ...
      <p>
        ...
        скрипт — по совпадению данных или решению администратора. Для услуги с
        <code>check_fields</code> платформа делает так всегда, даже без флага:
        заказ со сверкой данных не закрывается словом исполнителя.
      </p>
