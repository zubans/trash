...
func (m *mockAdminRepo) BroadcastEmails(ctx context.Context, role string, includeUnverified bool) ([]string, error) {
...
func (m *mockAdminRepo) GetUserTransactions(ctx context.Context, userID uuid.UUID, limit, offset int) ([]*repository.Transaction, int, error) {
	return nil, 0, nil
}

func (m *mockAdminRepo) GetUserOrders(ctx context.Context, userID uuid.UUID, limit, offset int) ([]*repository.AdminOrder, int, error) {
	return nil, 0, nil
}
...
func (m *mockAdminRepo) GetOrders(ctx context.Context, f repository.OrdersFilter) ([]*repository.AdminOrder, int, error) {
	return nil, 0, nil
}

func (m *mockAdminRepo) OrderFacets(ctx context.Context, statuses []repository.OrderStatus) (repository.OrderFacets, error) {
