...
var permissionCatalog = []PermissionSection{
	...
	{Key: "checks", Label: "Статус «проверенный»", Group: "Система", Route: "/admin/check-requests",
		Actions: []string{ActionView, ActionEdit},
	...
	{Key: "disputes", Label: "Споры", Group: "Система", Route: "/admin/disputes",
		Actions: []string{ActionView, ActionEdit},
		Hint:    "Правка — решение арбитра по спору: кто прав и кому штрафной балл. Решение двигает деньги."},
	{Key: "watermarks", Label: "Символы подтверждения", Group: "Система", Route: "/admin/watermark-symbols",
		Actions: []string{ActionView, ActionCreate, ActionEdit, ActionDelete},
		Hint:    "Жесты, которые исполнитель показывает на фото-подтверждении заказа."},
	{Key: "penalties", Label: "Штрафные баллы", Group: "Система", Route: "",
		Actions: []string{ActionEdit},
		Hint:    "Отмена ошибочного балла и сброс флага прошлой тихой блокировки. Отдельного пункта меню нет: действия — на карточке пользователя."},
